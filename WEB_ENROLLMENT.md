...
The join webpage (`web/public/`) provides a web-based enrollment interface that mirrors the SDK's decision tree. It's meant to run at `ctrl.konoss.org` or any HTTP server.
