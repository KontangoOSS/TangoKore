...
- Whether user joins via public (`ctrl.konoss.org`) or private server
...
├── DEPLOY_JOIN_ENDPOINT.md      - How to get ctrl.konoss.org working
│
...
3. Users join via your controller instead of public `ctrl.konoss.org`
...
**Immediate (This Week):**
1. Diagnose why `ctrl.konoss.org` is offline
