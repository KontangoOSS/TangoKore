...
| **Can I delete it?** | Yes—contact privacy@kontango.net or delete from your controller |
...
### 1. Using Public Enrollment (join.kontango.net)
```
...
Kontango's Policy:
  ...
  • Covered by kontango.net privacy policy & GDPR DPA
```
...
- ✓ Delete record anytime (email privacy@kontango.net)
...
**Non-interactive:**
```
kontango enroll https://join.kontango.net --no-tui
    ↓
...
**Interactive (TUI):**
```
kontango enroll https://join.kontango.net
    ↓
...
**Email:** privacy@kontango.net (title: "DATA DELETION REQUEST")  
...
### Technical Support
**Self-Hosted:** docs.kontango.net/self-hosted  
...
- **kontango.net/privacy** — Public privacy policy
- **kontango.net/terms** — Terms of service
