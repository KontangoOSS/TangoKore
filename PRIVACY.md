...
| **Can I delete it?** | Yes—contact privacy@konoss.org or delete from your controller |
...
### 1. Using Public Enrollment (ctrl.konoss.org)
```
...
Kontango's Policy:
  ...
  • Covered by konoss.org privacy policy & GDPR DPA
```
...
- ✓ Delete record anytime (email privacy@konoss.org)
...
**Email:** privacy@konoss.org (title: "DATA DELETION REQUEST")  
...
### Technical Support
**Self-Hosted:** docs.konoss.org/self-hosted  
...
- **konoss.org/privacy** — Public privacy policy
- **konoss.org/terms** — Terms of service
