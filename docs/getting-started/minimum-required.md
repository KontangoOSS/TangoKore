...
```bash
kontango enroll https://join.kontango.net --scan
```
...
5. **Right to Delete:** Request deletion from Kontango anytime (email privacy@kontango.net)
...
- **kontango.net/privacy** — Kontango's public privacy policy
