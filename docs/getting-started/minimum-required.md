...
```bash
kontango enroll https://ctrl.konoss.org --scan
```
...
5. **Right to Delete:** Request deletion from Kontango anytime (email privacy@konoss.org)
...
- **konoss.org/privacy** — Kontango's public privacy policy
