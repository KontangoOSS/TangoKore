...
```
1. kontango enroll https://join.kontango.net
      ↓
...
Privacy & Control:
  • Public enrollment: data processed by Kontango (kontango.net)
...
kontango enroll https://join.kontango.net --role-id foo --secret-id bar
```
...
✅ Right to deletion (privacy@kontango.net)  
...
README.md (entry point) → Privacy & Compliance section ↓
                            ...
                            └─ kontango.net/privacy (public policy)
...
3. Reference kontango.net/privacy for public policy
