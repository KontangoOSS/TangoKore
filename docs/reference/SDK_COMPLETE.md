...
```
1. kontango enroll https://ctrl.konoss.org
      ↓
...
Privacy & Control:
  • Public enrollment: data processed by Kontango (konoss.org)
...
kontango enroll https://ctrl.konoss.org --role-id foo --secret-id bar
```
...
✅ Right to deletion (privacy@konoss.org)  
...
README.md (entry point) → Privacy & Compliance section ↓
                            ...
                            └─ konoss.org/privacy (public policy)
...
3. Reference konoss.org/privacy for public policy
