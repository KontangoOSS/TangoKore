...
- One command: `kontango enroll https://join.kontango.net`
...
3. Run: `kontango enroll https://join.kontango.net`
...
4. Contact legal@kontango.net for specific questions
...
**Privacy Questions:** privacy@kontango.net  
**Data Deletion Requests:** privacy@kontango.net (title: "DATA DELETION REQUEST")  
**Legal/Compliance:** legal@kontango.net  
