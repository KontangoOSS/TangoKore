...
- **One command to join** — `curl https://ctrl.konoss.org/install | sudo sh`
...
- Integration tests with real ctrl.konoss.org endpoint
...
**Location:** `web/public/` + deployed at `ctrl.konoss.org`
...
```
User runs:  curl https://ctrl.konoss.org/install | sudo sh
            ↓
...
### Join Endpoint
- **URL:** `https://ctrl.konoss.org/install`
...
# Test with ctrl.konoss.org
./build/kontango enroll https://ctrl.konoss.org --no-tui
```
...
2. Visit `https://docs.konoss.org` for technical docs
3. Fork `https://github.com/KontangoOSS/TangoKore`
4. Build SDKs in your language of choice

**For Operations:**
1. Deploy join endpoint at `ctrl.konoss.org`
