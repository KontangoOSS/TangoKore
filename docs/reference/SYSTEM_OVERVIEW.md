...
- Whether user joins via public (`join.kontango.net`) or private server
...
├── DEPLOY_JOIN_ENDPOINT.md      - How to get join.kontango.net working
│
...
3. Users join via your controller instead of public `join.kontango.net`
...
**Immediate (This Week):**
1. Diagnose why `join.kontango.net` is offline
