...
### Option A: Public Enrollment (join.kontango.net)
...
Privacy: If you run your own controller, only you see this data.
         If using public join.kontango.net, equivalent to a DNS lookup.
```
...
### Privacy Policy
For public enrollment (join.kontango.net):
- [kontango.net/privacy](https://kontango.net/privacy)
- Details about data processing, retention, third parties

### Terms of Service
For public controller usage:
- [kontango.net/terms](https://kontango.net/terms)
- SLAs, limitations, acceptable use

### Self-Hosted Documentation
To run your own controller:
- [docs.kontango.net/self-hosted](https://docs.kontango.net/self-hosted)
...
### Data Processing
By enrolling against join.kontango.net, you consent to:
...
- Public endpoint: `https://join.kontango.net:443`
...
### Public Infrastructure (join.kontango.net)
...
**Your Control:**
- Request deletion anytime: **delete@kontango.net**
- Request export anytime: **export@kontango.net**
...
- Contact **compliance@kontango.net**
...
- **Public Notice:** Changes posted at kontango.net/ula
...
**Email:** privacy@kontango.net  
**Portal:** kontango.net/contact

### Legal Requests (Law Enforcement)
We respond to valid legal requests.  
**Email:** legal@kontango.net

### Self-Hosting Support
**Docs:** docs.kontango.net/self-hosted  
...
Running `kontango enroll https://join.kontango.net` means:
- You accept this ULA
...
**A:** Contact privacy@kontango.net with your machine IDs. We'll delete within 24 hours and remove from backups within 30 days.
...
*For questions or concerns, contact: legal@kontango.net*
