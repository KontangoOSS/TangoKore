...
### Option A: Public Enrollment (ctrl.konoss.org)
...
Privacy: If you run your own controller, only you see this data.
         If using public ctrl.konoss.org, equivalent to a DNS lookup.
```
...
### Privacy Policy
For public enrollment (ctrl.konoss.org):
- [konoss.org/privacy](https://konoss.org/privacy)
- Details about data processing, retention, third parties

### Terms of Service
For public controller usage:
- [konoss.org/terms](https://konoss.org/terms)
- SLAs, limitations, acceptable use

### Self-Hosted Documentation
To run your own controller:
- [docs.konoss.org/self-hosted](https://docs.konoss.org/self-hosted)
...
### Data Processing
By enrolling against ctrl.konoss.org, you consent to:
...
- Public endpoint: `https://ctrl.konoss.org:443`
...
### Public Infrastructure (ctrl.konoss.org)
...
**Your Control:**
- Request deletion anytime: **delete@konoss.org**
- Request export anytime: **export@konoss.org**
...
- **Public Notice:** Changes posted at konoss.org/ula
...
**Email:** privacy@konoss.org  
**Portal:** konoss.org/contact

### Legal Requests (Law Enforcement)
We respond to valid legal requests.  
**Email:** legal@konoss.org

### Self-Hosting Support
**Docs:** docs.konoss.org/self-hosted  
...
Running `kontango enroll https://ctrl.konoss.org` means:
- You accept this ULA
...
**A:** Contact privacy@konoss.org with your machine IDs. We'll delete within 24 hours and remove from backups within 30 days.
...
*For questions or concerns, contact: legal@konoss.org*
