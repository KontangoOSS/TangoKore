...
func runEnroll(url, session, roleID, secretID string, scanMethod bool) error {
	...
	log.Println("═══════════════════════════════════════════════════════════════")
	log.Println("KONTANGO SDK DISCLOSURE")
	log.Println("═══════════════════════════════════════════════════════════════")
	log.Println("")
	log.Println("Required minimum to install & run the SDK:")
	log.Println("  • Operating system (linux/darwin/windows)")
	log.Println("  • CPU architecture (amd64/arm64/etc)")
	log.Println("  • Machine identifier (auto-issued if you don't provide one)")
	log.Println("")
	log.Println("Optional enhancements (you opt-in):")
	log.Println("  • Hostname, OS version, kernel")
	log.Println("  • CPU model, system memory")
	log.Println("  • Network MAC addresses")
	log.Println("  • AppRole credentials (for trusted enrollment)")
	log.Println("")
	log.Println("Privacy & Control:")
	log.Println("  • Public enrollment: data processed by Kontango (kontango.net)")
	log.Println("  • Private controller: only you see the data")
	log.Println("  • Full rights: see MIRANDA_RIGHTS.md in the SDK")
	log.Println("")
	log.Println("═══════════════════════════════════════════════════════════════")
	log.Println("")
