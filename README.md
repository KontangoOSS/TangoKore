...
```bash
curl https://join.kontango.net/install | sudo sh --role-id xxx --secret-id yyy
```
...
Want to understand more? Check out the **[detailed docs](https://docs.kontango.net)** where we explain:
