...
<p align="center">
  <a href="https://kontango.io">kontango.io</a> · <a href="https://github.com/KontangoOSS/TangoKore/releases">Releases</a> · <a href="docs/ARCHITECTURE.md">Architecture</a> · <a href="docs/PROFILES.md">Profiles</a> · <a href="supported.yaml">Platform Matrix</a>
</p>
...
```sh
curl -fsSL https://join.kontango.net/install | sudo sh
```
...
curl -fsSL https://join.kontango.net/install | sudo sh -s -- --mode=portal

# Headless worker — no UI, claimed by the controller via a deploy command
curl -fsSL https://join.kontango.net/install | sudo sh -s -- --mode=service
```
...
Browse the full catalog at **[kontango.io](https://kontango.io)**.
...
- Self-hosting guide: [docs.kontango.net/self-hosted](https://docs.kontango.net/self-hosted)
...
- **Right to Delete:** Request deletion anytime (contact privacy@kontango.net)
...
<p align="center">
  <a href="https://kontango.io"><strong>kontango.io</strong></a>
</p>
