...
curl -k https://join.kontango.net/install | head -10

# Run full installation
curl -k https://join.kontango.net/install | sudo sh
...
1. **Web** — Users visit `https://join.kontango.net/` → see new UI
2. **Installer** — `curl https://join.kontango.net/install | sh` works
...
2. **Restore service** — Get `https://join.kontango.net/` responding
