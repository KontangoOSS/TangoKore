...
func TestDisclosure_NonInteractive(t *testing.T) {
	...
	log.Printf("║    kontango enroll https://join.kontango.net --no-tui          ║")
	log.Printf("╚════════════════════════════════════════════════════════════════╝\n")
	...
	log.Printf("If using public join.kontango.net, equivalent to a DNS lookup.\n")
	log.Printf("\n")
	log.Printf("═══════════════════════════════════════════════════════════════\n")
	log.Printf("\n")
...
func TestDisclosure_TUI(t *testing.T) {
	...
	log.Printf("║         (This is what users see when they run)               ║")
	log.Printf("║         kontango enroll https://join.kontango.net            ║")
