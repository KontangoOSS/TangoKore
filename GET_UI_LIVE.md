...
### Desired State
1. User visits `https://ctrl.konoss.org/` → sees enrollment web UI
...
curl https://ctrl.konoss.org/ | grep -c "Welcome to TangoKore"
# Should output: 1
...
# Test CSS loads
curl https://ctrl.konoss.org/css/style.css | head -5
# Should return: CSS content

# Test JavaScript loads
curl https://ctrl.konoss.org/js/main.js | head -5
...
```bash
# 1. Visit web UI
curl https://ctrl.konoss.org/ | head -20
...
### After Deployment
- [ ] Test public endpoint (`https://ctrl.konoss.org/`)
- [ ] HTML loads
- [ ] CSS loads
- [ ] JavaScript loads
...
✅ `https://ctrl.konoss.org/` returns HTML (enrollment UI)  
...
✅ `https://ctrl.konoss.org/install` returns shell script  
